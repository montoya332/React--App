	...
	render() {
		return (
			<div className="cloud_container">
				<div>
					<div className="cloud cloud--x1"></div>
					<div className="cloud cloud--x1_5"></div>
					<div className="cloud cloud--x2"></div>
					<div className="cloud cloud--x3"></div>
					<div className="cloud cloud--x4"></div>
					<div className="cloud cloud--x5"></div>
				</div>
